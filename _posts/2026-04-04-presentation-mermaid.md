...
Son utilisation est très simple, soit via l'[éditeur gratuit](https://mermaid.ai/live/) , soit via son intégration dans certains outils : sur Obsidian, Github (cliquez sur le bouton ".md" sous le titre de cet article pour voir Mermaid en action sur Github !) , VSCode, Notion, Microsoft Loop... [la liste est longue](https://mermaid.ai/open-source/ecosystem/integrations-community.html#productivity-tools) !  
